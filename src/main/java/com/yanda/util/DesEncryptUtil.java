...
public class DesEncryptUtil {
	...
	public static String decrypt(String encryptedDataHex, String keyData) {
		...
		String decryptedHexStr = DesEncryptUtil.decryptToHex(StringUtil.toBytes(encryptedDataHex), keyData);
	...
	public static String decryptToHex(byte[] toDecryptData, String keyData) {
		byte[] decryptedData = doDecrypt(getKeyByData(keyData), toDecryptData,
